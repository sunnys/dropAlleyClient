...
const AsyncProductDashboard = asyncComponent(() => import('./containers/dashboards/ecommerce/product.component'));
...
export default ({ childProps, layout }) => {
  ...
  return (
    <Switch>
      ...
      <AppRoute path="/dashboards/ecommerce/product" exact component={AsyncProductDashboard} props={childProps} layout={activeLayout} />
